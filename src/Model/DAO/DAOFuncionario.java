...
public class DAOFuncionario {
    ...
    public static void alterarFuncionario(Funcionario funcionario) throws Exception {
        ...
        try {
            Statement stt = cnx.createStatement();
            stt.execute(String.format("UPDATE PESSOA SET NOME = '%s', DTNASCIMENTO = '%s', RG = '%s' WHERE ID = %d;", funcionario.getNome(), data.format(funcionario.getDtNascimento()), funcionario.getRg(), funcionario.getId()));
